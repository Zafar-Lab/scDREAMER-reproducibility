...
def metrics(
    ...
    if nmi_ or ari_:
        print('Clustering...')
        if embed=='X_pca':
            print('calculating PCA and neighbors')
            sc.tl.pca(adata_int)
    ...
    if isolated_labels_asw_ or isolated_labels_:
        ...
        il_score_asw = np.nan
    print('il_score_asw : ', il_score_asw)
    if graph_conn_:
    ...
    print("graph_conn_score ", graph_conn_score)
    if kBET_:
        print('kBET...')
        try:
            kbet_results = kBET(
    ...
    if lisi_graph_:
        ...
        ilisi_all = None
        clisi_all = None
    print('iLisi scaled ', ilisi_scaled)
    print('cLisi scaled ', clisi_scaled)
    if hvg_score_:
        hvg_score = hvg_overlap(adata, adata_int, batch_key)
    else:
        hvg_score = np.nan
    print('hvg_score ', hvg_score)
    if trajectory_:
    ...
    print('trajectory_score ', trajectory_score)
    results = {
